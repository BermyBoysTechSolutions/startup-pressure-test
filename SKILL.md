...
Match the user's language. Keep common startup terms in English: `ICP`, `MVP`, `PMF`, `early adopter`, `switching cost`, `wedge`.
...
Read `references/playbooks.md` for detailed prompt templates and criteria for each mode.
